...
Dynamically generates questions using an LLM to judge extraction fidelity against the raw transcript.
"""
import json
import sys
import re
...
def run_llm_judge(transcript_file: str, kg_file: str):
    ...
    # BUGFIX: Removed [:8000] slice to ensure the judge queries against the full transcript
